...
def plot_wahlbeteiligung(df):
    ...
    #     shadow = True,
    #     # colors = mycolors,
    #     wedgeprops={"width":0.5,"edgecolor":"white",'linewidth': 2, 'linestyle': 'solid', 'antialiased': True}
    #     )
...
def plot_verlobung(df):
    ...
    yyy = [count_groom, count_bride, count_who] #, count_no]
    labels = ["Partei des Bräutigams", "Partei der Braut",  "Wer seid ihr?"] #, "Keine Antwort"]
    advanced_bar(
        xx = xx,
        yyy = yyy,
        labels = labels,
